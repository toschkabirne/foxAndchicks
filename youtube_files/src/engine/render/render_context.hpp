...
public:
    ...
    void drawDirect(sf::Drawable const& drawable)
    {
...
private:
    ...
    void setWindow(sf::RenderWindow& window)
    {
        ...
        m_viewport_handler.state.window_size = window_size;
        m_viewport_handler.state.render_size = window_size;
    }
